package com.nihal.FileShare.service;
...
import com.nihal.FileShare.app.Service;
import com.nihal.FileShare.config.AppConfig;
import com.nihal.FileShare.config.Keyword;
import com.nihal.FileShare.database.AccessDatabase;
import com.nihal.FileShare.exception.AssigneeNotFoundException;
import com.nihal.FileShare.exception.ConnectionNotFoundException;
import com.nihal.FileShare.exception.DeviceNotFoundException;
import com.nihal.FileShare.exception.TransferGroupNotFoundException;
import com.nihal.FileShare.fragment.FileListFragment;
import com.nihal.FileShare.object.NetworkDevice;
import com.nihal.FileShare.object.TextStreamObject;
import com.nihal.FileShare.object.TransferGroup;
import com.nihal.FileShare.object.TransferInstance;
import com.nihal.FileShare.object.TransferObject;
import com.nihal.FileShare.util.AppUtils;
import com.nihal.FileShare.util.CommunicationBridge;
import com.nihal.FileShare.util.CommunicationNotificationHelper;
import com.nihal.FileShare.util.DynamicNotification;
import com.nihal.FileShare.util.FileUtils;
import com.nihal.FileShare.util.HotspotUtils;
import com.nihal.FileShare.util.NetworkDeviceLoader;
import com.nihal.FileShare.util.NetworkUtils;
import com.nihal.FileShare.util.NotificationUtils;
import com.nihal.FileShare.util.NsdDiscovery;
import com.nihal.FileShare.util.TimeUtils;
import com.nihal.FileShare.util.TransferUtils;
import com.nihal.FileShare.util.UpdateUtils;
